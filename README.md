...
## Step #3:
  ...
  Edit the site-config.json file and update the required information as per the site (SNMP community, border router/switch interfaces, and https)
   ...
   Note: Add the identification of interfaces and index number which is important here and also select the correct path of certs **(/root/site-net-monitor/certs/FILENAME.pem)**.
